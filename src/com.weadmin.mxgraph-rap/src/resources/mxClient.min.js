...
l.previous.y)*n,s=(l.geometry.width-l.previous.width)*n,n=(l.geometry.height-l.previous.height)*n;0==d?(m.x-=p,m.y-=q,m.width-=s,m.height-=n):(m.x+=p/10,m.y+=q/10,m.width+=s/10,m.height+=n/10);a.cellRenderer.redraw(m);mxEffects.cascadeOpacity(a,l.cell,100*d/10)}}}10>d&&g?(d++,window.setTimeout(e,f)):null!=c&&c()},f=30;e()},cascadeOpacity:function(a,b,c){for(var d=a.model.getChildCount(b),e=0;e<d;e++){var f=a.model.getChildAt(b,e),g=a.getView().getState(f);null!=g&&(mxUtils.setOpacity(g.shape.node,
...
mxDivResizer.prototype.getDocumentHeight=function(){return document.body.clientHeight};function mxDragSource(a,b){this.element=a;this.dropHandler=b;mxEvent.addGestureListeners(a,mxUtils.bind(this,function(a){this.mouseDown(a)}));mxEvent.addListener(a,"dragstart",function(a){mxEvent.consume(a)});this.eventConsumer=function(a,b){var e=b.getProperty("eventName"),f=b.getProperty("event");e!=mxEvent.MOUSE_DOWN&&f.consume()}}mxDragSource.prototype.element=null;mxDragSource.prototype.dropHandler=null;
...
mxSvgCanvas2D.prototype.updateText=function(a,b,c,d,e,f,g,k,l,m,n){if(null!=n&&null!=n.firstChild&&null!=n.firstChild.firstChild&&null!=n.firstChild.firstChild.firstChild){n=n.firstChild;var p=n.firstChild,q=p.firstChild;m=null!=m?m:0;var s=this.state;a+=s.dx;b+=s.dy;l?(q.style.maxHeight=Math.round(d)+"px",q.style.maxWidth=Math.round(c)+"px"):"fill"==k?(q.style.width=Math.round(c+1)+"px",q.style.height=Math.round(d+1)+"px"):"width"==k&&(q.style.width=Math.round(c+1)+"px",0<d&&(q.style.maxHeight=Math.round(d)+
"px"));g&&0<c&&(q.style.width=Math.round(c+1)+"px");var r=0,t=0,t=q;null!=t.firstChild&&"DIV"==t.firstChild.nodeName&&(t=t.firstChild);r=(null!=n.mxCachedOffsetWidth?n.mxCachedOffsetWidth:t.offsetWidth)+2;g&&"fill"!=k&&(l&&(r=Math.min(r,c)),q.style.width=r+"px");r=(null!=n.mxCachedFinalOffsetWidth?n.mxCachedFinalOffsetWidth:t.offsetWidth)+2;t=(null!=n.mxCachedFinalOffsetHeight?n.mxCachedFinalOffsetHeight:t.offsetHeight)-2;l&&(t=Math.min(t,d),r=Math.min(r,c));"width"==k?d=t:"fill"!=k&&(c=r,d=t);l=
...
n);(!this.styleEnabled||q!=mxConstants.DEFAULT_FONTSIZE)&&s.setAttribute("font-size",q*k.scale+"px");0<r.length&&s.setAttribute("transform",r);1>k.alpha&&s.setAttribute("opacity",k.alpha);r=e.split("\n");p=Math.round(q*mxConstants.LINE_HEIGHT);var t=q+(r.length-1)*p;n=b+q-1;g==mxConstants.ALIGN_MIDDLE?"fill"==l?n-=d/2:(m=(this.matchHtmlAlignment&&m&&0<d?Math.min(t,d):t)/2,n-=m+1):g==mxConstants.ALIGN_BOTTOM&&("fill"==l?n-=d:(m=this.matchHtmlAlignment&&m&&0<d?Math.min(t,d):t,n-=m+2));for(m=0;m<r.length;m++)0<
r[m].length&&0<mxUtils.trim(r[m]).length&&(q=this.createElement("text"),q.setAttribute("x",this.format(a*k.scale)+this.textOffset),q.setAttribute("y",this.format(n*k.scale)+this.textOffset),mxUtils.write(q,r[m]),s.appendChild(q)),n+=p;this.root.appendChild(s);this.addTextBackground(s,e,a,b,c,"fill"==l?d:t,f,g,l)};
...
(function(){function a(a){a=null!=a?a:2;return function(b,c,g,k,l,m,n,p,q,s){c=1.118*l*q;p=1.118*m*q;l*=n+q;m*=n+q;var r=k.clone();r.x-=c;r.y-=p;n=g!=mxConstants.ARROW_CLASSIC&&g!=mxConstants.ARROW_CLASSIC_THIN?1:0.75;k.x+=-l*n-c;k.y+=-m*n-p;return function(){b.begin();b.moveTo(r.x,r.y);b.lineTo(r.x-l-m/a,r.y-m+l/a);(g==mxConstants.ARROW_CLASSIC||g==mxConstants.ARROW_CLASSIC_THIN)&&b.lineTo(r.x-3*l/4,r.y-3*m/4);b.lineTo(r.x+m/a-l,r.y-m-l/a);b.close();s?b.fillAndStroke():b.stroke()}}}function b(a){a=
null!=a?a:2;return function(b,c,g,k,l,m,n,p,q,s){c=1.118*l*q;g=1.118*m*q;l*=n+q;m*=n+q;var r=k.clone();r.x-=c;r.y-=g;k.x+=2*-c;k.y+=2*-g;return function(){b.begin();b.moveTo(r.x-l-m/a,r.y-m+l/a);b.lineTo(r.x,r.y);b.lineTo(r.x+m/a-l,r.y-m-l/a);b.stroke()}}}function c(a,b,c,g,k,l,m,n,p,q){n=c==mxConstants.ARROW_DIAMOND?0.7071:0.9862;b=k*p*n;n*=l*p;k*=m+p;l*=m+p;var s=g.clone();s.x-=b;s.y-=n;g.x+=-k-b;g.y+=-l-n;var r=c==mxConstants.ARROW_DIAMOND?2:3.4;return function(){a.begin();a.moveTo(s.x,s.y);a.lineTo(s.x-
k/2-l/r,s.y+k/r-l/2);a.lineTo(s.x-k,s.y-l);a.lineTo(s.x-k/2+l/r,s.y-l/2-k/r);a.close();q?a.fillAndStroke():a.stroke()}}mxMarker.addMarker("classic",a(2));mxMarker.addMarker("classicThin",a(3));mxMarker.addMarker("block",a(2));mxMarker.addMarker("blockThin",a(3));mxMarker.addMarker("open",b(2));mxMarker.addMarker("openThin",b(3));mxMarker.addMarker("oval",function(a,b,c,g,k,l,m,n,p,q){var s=m/2,r=g.clone();g.x-=k*s;g.y-=l*s;return function(){a.ellipse(r.x-s,r.y-s,m,m);q?a.fillAndStroke():a.stroke()}});
...
(e=Math.min(e,this.bounds.width)),g.style.width=e+"px"):g.style.whiteSpace="nowrap";k=g;null!=k.firstChild&&"DIV"==k.firstChild.nodeName&&(k=k.firstChild,this.wrap&&"break-word"==g.style.wordWrap&&(k.style.width="100%"));!this.clipped&&(this.wrap&&0<l)&&(e=k.offsetWidth+this.textWidthPadding,g.style.width=e+"px");f=k.offsetHeight+2;mxClient.IS_QUIRKS&&(null!=this.border&&this.border!=mxConstants.NONE)&&(f+=3)}else null!=k.firstChild&&"DIV"==k.firstChild.nodeName&&(k=k.firstChild,f=k.offsetHeight);
e=k.offsetWidth+this.textWidthPadding;this.clipped&&(f=Math.min(f,this.bounds.height));l=this.bounds.width/d;g=this.bounds.height/d;"fill"==this.overflow?(f=g,e=l):"width"==this.overflow&&(f=k.scrollHeight,e=l);this.offsetWidth=e;this.offsetHeight=f;mxClient.IS_QUIRKS&&(this.clipped||"width"==this.overflow&&0<g)?(g=Math.min(g,f),a.height=Math.round(g)+"px"):g=f;if("fill"!=this.overflow&&"width"!=this.overflow&&(this.clipped&&(e=Math.min(l,e)),l=e,mxClient.IS_QUIRKS&&this.clipped||this.wrap))a.width=
Math.round(l)+"px";var g=g*d,l=l*d,m=this.getTextRotation()*(Math.PI/180),e=parseFloat(parseFloat(Math.cos(m)).toFixed(8)),f=parseFloat(parseFloat(Math.sin(-m)).toFixed(8)),m=m%(2*Math.PI);0>m&&(m+=2*Math.PI);m%=Math.PI;m>Math.PI/2&&(m=Math.PI-m);var k=Math.cos(m),n=Math.sin(-m),b=l*-(b+0.5),p=g*-(c+0.5),q=(g-g*k+l*n)/2+f*b-e*p;0!=m&&(c="progid:DXImageTransform.Microsoft.Matrix(M11\x3d"+e+", M12\x3d"+f+", M21\x3d"+-f+", M22\x3d"+e+", sizingMethod\x3d'auto expand')",a.filter=null!=a.filter&&0<a.filter.length?
a.filter+(" "+c):c);c=0;"fill"!=this.overflow&&mxClient.IS_QUIRKS&&(c=this.valign==mxConstants.ALIGN_TOP?c-1:this.valign==mxConstants.ALIGN_BOTTOM?c+2:c+1);a.zoom=d;a.left=Math.round(this.bounds.x+((l-l*k+g*n)/2-e*b-f*p)-l/2)+"px";a.top=Math.round(this.bounds.y+q-g/2+c)+"px"};
...
mxConstants.STYLE_HORIZONTAL,!0);null!=b&&(l=k?Math.min(l,b.height):Math.min(l,b.width));c==k&&(e-=l);k?g+=l:f+=l}d.beginUpdate();try{for(var l=0,k=null,m=0,n=null,p=d.getChildCount(a),q=0;q<p;q++){var s=d.getChildAt(a,q);if(!this.isVertexIgnored(s)&&this.isVertexMovable(s)){var r=d.getGeometry(s);if(null!=r){r=r.clone();if(null!=this.wrap&&null!=k&&(c&&k.x+k.width+r.width+2*this.spacing>this.wrap||!c&&k.y+k.height+r.height+2*this.spacing>this.wrap))k=null,c?g+=l+this.spacing:f+=l+this.spacing,l=
0;var l=Math.max(l,c?r.height:r.width),t=0;if(!this.borderCollapse)var y=this.graph.getCellStyle(s),t=mxUtils.getNumber(y,mxConstants.STYLE_STROKEWIDTH,1);null!=k?c?r.x=m+this.spacing+Math.floor(t/2):r.y=m+this.spacing+Math.floor(t/2):this.keepFirstLocation||(c?r.x=f:r.y=g);c?r.y=g:r.x=f;this.fill&&null!=e&&(c?r.height=e:r.width=e);this.setChildGeometry(s,r);n=s;k=r;m=c?k.x+k.width+Math.floor(t/2):k.y+k.height+Math.floor(t/2)}}}this.resizeParent&&null!=b&&null!=k&&!this.graph.isCellCollapsed(a)?this.updateParentGeometry(a,
...
e[l].cell.cell,n=this.getVertexBounds(m),m=this.graph.getEdgesBetween(c,m,!1),p=[],q=0,s=0,r=0;r<m.length;r++)this.horizontal?(q=k.x+k.width,s=k.y+b,p.push(new mxPoint(q,s)),q=k.x+k.width+f,p.push(new mxPoint(q,s)),s=n.y+n.height/2):(q=k.x+b,s=k.y+k.height,p.push(new mxPoint(q,s)),s=k.y+k.height+f,p.push(new mxPoint(q,s)),q=n.x+n.width/2),p.push(new mxPoint(q,s)),this.setEdgePoints(m[r],p);l<d/2?f+=this.prefVertEdgeOff:l>d/2&&(f-=this.prefVertEdgeOff);b+=a;g=Math.max(g,f)}};
...
(p=1,null!=n.edges?p=n.edges.length:mxLog.warn("edge.edges is null"),n.width=(p-1)*this.parallelEdgeSpacing);k+=n.width/2;n.setX(e,k);n.setGeneralPurposeVariable(e,k);k+=n.width/2;k+=this.intraCellSpacing;k>this.widestRankValue&&(this.widestRankValue=k,this.widestRank=e);this.rankWidths[e]=k}!0==l&&mxLog.warn("At least one cell has no bounds");this.rankY[e]=c;k=f/2+d/2+this.interRankCellSpacing;d=f;c=this.orientation==mxConstants.DIRECTION_NORTH||this.orientation==mxConstants.DIRECTION_WEST?c+k:c-
...
l,r=c.y-m,s=e?Math.atan2(s,r):Math.atan2(r,s),t=e?Math.atan2(k,a):Math.atan2(a,k),r=!1,r=b==mxConstants.DIRECTION_NORTH||b==mxConstants.DIRECTION_WEST?s>-t&&s<t:s<-Math.PI+t||s>Math.PI-t,t=null;r?t=d&&(e&&c.x>=n.x&&c.x<=q.x||!e&&c.y>=n.y&&c.y<=q.y)?e?new mxPoint(c.x,n.y):new mxPoint(n.x,c.y):b==mxConstants.DIRECTION_NORTH?new mxPoint(f+k/2+a*Math.tan(s)/2,g+a):b==mxConstants.DIRECTION_SOUTH?new mxPoint(f+k/2-a*Math.tan(s)/2,g):b==mxConstants.DIRECTION_WEST?new mxPoint(f+k,g+a/2+k*Math.tan(s)/2):new mxPoint(f,
g+a/2-k*Math.tan(s)/2):(d&&(d=new mxPoint(l,m),c.y>=g&&c.y<=g+a?(d.x=e?l:b==mxConstants.DIRECTION_WEST?f+k:f,d.y=c.y):c.x>=f&&c.x<=f+k&&(d.x=c.x,d.y=!e?m:b==mxConstants.DIRECTION_NORTH?g+a:g),l=d.x,m=d.y),t=e&&c.x<=f+k/2||!e&&c.y<=g+a/2?mxUtils.intersection(c.x,c.y,l,m,n.x,n.y,p.x,p.y):mxUtils.intersection(c.x,c.y,l,m,p.x,p.y,q.x,q.y));null==t&&(t=new mxPoint(l,m));return t},HexagonPerimeter:function(a,b,c,d){var e=a.x,f=a.y,g=a.width,k=a.height,l=a.getCenterX();a=a.getCenterY();var m=c.x,n=c.y,p=
-Math.atan2(n-a,m-l),q=Math.PI,s=Math.PI/2,r=new mxPoint(l,a);b=null!=b?mxUtils.getValue(b.style,mxConstants.STYLE_DIRECTION,mxConstants.DIRECTION_EAST):mxConstants.DIRECTION_EAST;var t=b==mxConstants.DIRECTION_NORTH||b==mxConstants.DIRECTION_SOUTH;b=new mxPoint;r=new mxPoint;if(m<e&&n<f||m<e&&n>f+k||m>e+g&&n<f||m>e+g&&n>f+k)d=!1;if(d){if(t){if(m==l){if(n<=f)return new mxPoint(l,f);if(n>=f+k)return new mxPoint(l,f+k)}else if(m<e){if(n==f+k/4)return new mxPoint(e,f+k/4);if(n==f+3*k/4)return new mxPoint(e,
f+3*k/4)}else if(m>e+g){if(n==f+k/4)return new mxPoint(e+g,f+k/4);if(n==f+3*k/4)return new mxPoint(e+g,f+3*k/4)}else if(m==e){if(n<a)return new mxPoint(e,f+k/4);if(n>a)return new mxPoint(e,f+3*k/4)}else if(m==e+g){if(n<a)return new mxPoint(e+g,f+k/4);if(n>a)return new mxPoint(e+g,f+3*k/4)}if(n==f)return new mxPoint(l,f);if(n==f+k)return new mxPoint(l,f+k);m<l?n>f+k/4&&n<f+3*k/4?(b=new mxPoint(e,f),r=new mxPoint(e,f+k)):n<f+k/4?(b=new mxPoint(e-Math.floor(0.5*g),f+Math.floor(0.5*k)),r=new mxPoint(e+
g,f-Math.floor(0.25*k))):n>f+3*k/4&&(b=new mxPoint(e-Math.floor(0.5*g),f+Math.floor(0.5*k)),r=new mxPoint(e+g,f+Math.floor(1.25*k))):m>l&&(n>f+k/4&&n<f+3*k/4?(b=new mxPoint(e+g,f),r=new mxPoint(e+g,f+k)):n<f+k/4?(b=new mxPoint(e,f-Math.floor(0.25*k)),r=new mxPoint(e+Math.floor(1.5*g),f+Math.floor(0.5*k))):n>f+3*k/4&&(b=new mxPoint(e+Math.floor(1.5*g),f+Math.floor(0.5*k)),r=new mxPoint(e,f+Math.floor(1.25*k))))}else{if(n==a){if(m<=e)return new mxPoint(e,f+k/2);if(m>=e+g)return new mxPoint(e+g,f+k/
...
g,f)):m<e+g/4?(b=new mxPoint(e-Math.floor(0.25*g),f+k),r=new mxPoint(e+Math.floor(0.5*g),f-Math.floor(0.5*k))):m>e+3*g/4&&(b=new mxPoint(e+Math.floor(0.5*g),f-Math.floor(0.5*k)),r=new mxPoint(e+Math.floor(1.25*g),f+k)):n>a&&(m>e+g/4&&m<e+3*g/4?(b=new mxPoint(e,f+k),r=new mxPoint(e+g,f+k)):m<e+g/4?(b=new mxPoint(e-Math.floor(0.25*g),f),r=new mxPoint(e+Math.floor(0.5*g),f+Math.floor(1.5*k))):m>e+3*g/4&&(b=new mxPoint(e+Math.floor(0.5*g),f+Math.floor(1.5*k)),r=new mxPoint(e+Math.floor(1.25*g),f)))}d=
l;p=a;m>=e&&m<=e+g?(d=m,p=n<a?f+k:f):n>=f&&n<=f+k&&(p=n,d=m<l?e+g:e);r=mxUtils.intersection(d,p,c.x,c.y,b.x,b.y,r.x,r.y)}else{if(t){m=Math.atan2(k/4,g/2);if(p==m)return new mxPoint(e+g,f+Math.floor(0.25*k));if(p==s)return new mxPoint(e+Math.floor(0.5*g),f);if(p==q-m)return new mxPoint(e,f+Math.floor(0.25*k));if(p==-m)return new mxPoint(e+g,f+Math.floor(0.75*k));if(p==-s)return new mxPoint(e+Math.floor(0.5*g),f+k);if(p==-q+m)return new mxPoint(e,f+Math.floor(0.75*k));p<m&&p>-m?(b=new mxPoint(e+g,f),
...
0);this.resize();if(null!=this.textarea)try{this.textarea.focus(),this.isSelectText()&&(0<this.textarea.innerHTML.length&&(this.textarea.innerHTML!=this.getEmptyLabelText()||!this.clearOnChange))&&document.execCommand("selectAll",!1,null)}catch(n){}}};mxCellEditor.prototype.isSelectText=function(){return this.selectText};
...
mxGraphView.prototype.getRelativePoint=function(a,b,c){var d=this.graph.getModel().getGeometry(a.cell);if(null!=d){var e=a.absolutePoints.length;if(d.relative&&1<e){for(var d=a.length,f=a.segments,g=a.absolutePoints[0],k=a.absolutePoints[1],l=mxUtils.ptSegDistSq(g.x,g.y,k.x,k.y,b,c),m=0,n=0,p=0,q=2;q<e;q++)n+=f[q-2],k=a.absolutePoints[q],g=mxUtils.ptSegDistSq(g.x,g.y,k.x,k.y,b,c),g<=l&&(l=g,m=q-1,p=n),g=k;e=f[m];g=a.absolutePoints[m];k=a.absolutePoints[m+1];l=k.x;f=k.y;a=g.x-l;m=g.y-f;l=b-l;f=c-f;
l=a-l;f=m-f;f=l*a+f*m;a=Math.sqrt(0>=f?0:f*f/(a*a+m*m));a>e&&(a=e);e=Math.sqrt(mxUtils.ptSegDistSq(g.x,g.y,k.x,k.y,b,c));-1==mxUtils.relativeCcw(g.x,g.y,k.x,k.y,b,c)&&(e=-e);return new mxPoint(-2*((d/2-p-a)/d),e/this.scale)}}return new mxPoint};
...
Math.ceil(d.width/f.width)+1:0,k=a?Math.ceil(d.height/f.height)+1:0,l=(g-1)*f.width,m=(k-1)*f.height;null==this.horizontalPageBreaks&&0<g&&(this.horizontalPageBreaks=[]);null==this.verticalPageBreaks&&0<k&&(this.verticalPageBreaks=[]);a=mxUtils.bind(this,function(a){if(null!=a){for(var b=a==this.horizontalPageBreaks?g:k,c=0;c<=b;c++){var d=a==this.horizontalPageBreaks?[new mxPoint(f.x+c*f.width,f.y),new mxPoint(f.x+c*f.width,f.y+m)]:[new mxPoint(f.x,f.y+c*f.height),new mxPoint(f.x+l,f.y+c*f.height)];
...
mxGraph.prototype.cellsAdded=function(a,b,c,d,e,f,g){if(null!=a&&null!=b&&null!=c){this.model.beginUpdate();try{for(var k=f?this.view.getState(b):null,l=null!=k?k.origin:null,m=new mxPoint(0,0),k=0;k<a.length;k++)if(null==a[k])c--;else{var n=this.model.getParent(a[k]);if(null!=l&&a[k]!=b&&b!=n){var p=this.view.getState(n),q=null!=p?p.origin:m,s=this.model.getGeometry(a[k]);if(null!=s){var r=q.x-l.x,t=q.y-l.y,s=s.clone();s.translate(r,t);!s.relative&&(this.model.isVertex(a[k])&&!this.isAllowNegativeCoordinates())&&
(s.x=Math.max(0,s.x),s.y=Math.max(0,s.y));this.model.setGeometry(a[k],s)}}b==n&&c+k>this.model.getChildCount(b)&&c--;this.model.add(b,a[k],c+k);this.autoSizeCellsOnAdd&&this.autoSizeCell(a[k],!0);this.isExtendParentsOnAdd(a[k])&&this.isExtendParent(a[k])&&this.extendParent(a[k]);(null==g||g)&&this.constrainChild(a[k]);null!=d&&this.cellConnected(a[k],d,!0);null!=e&&this.cellConnected(a[k],e,!1)}this.fireEvent(new mxEventObject(mxEvent.CELLS_ADDED,"cells",a,"parent",b,"index",c,"source",d,"target",
...
null!=r&&this.model.isVertex(r.cell)&&(q=r.x/b,s=r.y/b);n=n.clone();p=p.absolutePoints;r=g?0:p.length-1;n.setTerminalPoint(new mxPoint(p[r].x/b-q,p[r].y/b-s),g);this.model.setTerminal(f[k],null,g);this.model.setGeometry(f[k],n)}}}}),k=0;k<f.length;k++)d.get(f[k])||(g(f[k],!0),g(f[k],!1));this.model.remove(a[e])}this.fireEvent(new mxEventObject(mxEvent.CELLS_REMOVED,"cells",a))}finally{this.model.endUpdate()}}};
...
e.relative?this.model.isVertex(g)&&g!=this.view.currentRoot&&(k=this.getBoundingBoxFromGeometry([g],!1),null!=k&&(f=new mxRectangle(e.x*k.width,e.y*k.height,e.width,e.height),0<=mxUtils.indexOf(a,g)&&(f.x+=k.x,f.y+=k.y))):(f=mxRectangle.fromRectangle(e),this.model.isVertex(g)&&0<=mxUtils.indexOf(a,g)&&(k=this.getBoundingBoxFromGeometry([g],!1),null!=k&&(f.x+=k.x,f.y+=k.y))),null!=f&&null!=e.offset&&(f.x+=e.offset.x,f.y+=e.offset.y);null!=f&&(null==c?c=mxRectangle.fromRectangle(f):c.add(f))}}return c};
...
mxGraph.prototype.getCellAt=function(a,b,c,d,e,f){d=null!=d?d:!0;e=null!=e?e:!0;null==c&&(c=this.getCurrentRoot(),null==c&&(c=this.getModel().getRoot()));if(null!=c)for(var g=this.model.getChildCount(c)-1;0<=g;g--){var k=this.model.getChildAt(c,g),l=this.getCellAt(a,b,k,d,e,f);if(null!=l)return l;if(this.isCellVisible(k)&&(e&&this.model.isEdge(k)||d&&this.model.isVertex(k)))if(l=this.view.getState(k),null!=l&&(null==f||!f(l,a,b))&&this.intersects(l,a,b))return k}return null};
...
mxGraph.prototype.findTreeRoots=function(a,b,c){b=null!=b?b:!1;c=null!=c?c:!1;var d=[];if(null!=a){for(var e=this.getModel(),f=e.getChildCount(a),g=null,k=0,l=0;l<f;l++){var m=e.getChildAt(a,l);if(this.model.isVertex(m)&&this.isCellVisible(m)){for(var n=this.getConnections(m,b?a:null),p=0,q=0,s=0;s<n.length;s++)this.view.getVisibleTerminal(n[s],!0)==m?p++:q++;(c&&0==p&&0<q||!c&&0==q&&0<p)&&d.push(m);n=c?q-p:p-q;n>k&&(k=n,g=m)}}0==d.length&&null!=g&&d.push(g)}return d};
...
d)>0?0:e.x-d,(e.y-c)>0?0:e.y-c);this.update();b.consume()}this.index=null;this.active=!1}};
...
Math.abs(this.previous.getCenterY()-c.y)?c.x=this.previous.getCenterX():c.y=this.previous.getCenterY());e=this.first;if(null!=this.selectedIcon){var g=this.selectedIcon.bounds.width,k=this.selectedIcon.bounds.height;null!=this.currentState&&this.targetConnectImage?(g=this.getIconPosition(this.selectedIcon,this.currentState),this.selectedIcon.bounds.x=g.x,this.selectedIcon.bounds.y=g.y):(g=new mxRectangle(b.getGraphX()+this.connectIconOffset.x,b.getGraphY()+this.connectIconOffset.y,g,k),this.selectedIcon.bounds=
...
(e=g)));if(null==this.currentState&&this.movePreviewAway){g=e;null!=this.edgeState&&2<=this.edgeState.absolutePoints.length&&(f=this.edgeState.absolutePoints[this.edgeState.absolutePoints.length-2],null!=f&&(g=f));f=d.x-g.x;g=d.y-g.y;k=Math.sqrt(f*f+g*g);if(0==k)return;this.originalPoint=d.clone();d.x-=4*f/k;d.y-=4*g/k}else this.originalPoint=null;if(null==this.shape&&(f=Math.abs(c.x-this.first.x),g=Math.abs(c.y-this.first.y),f>this.graph.tolerance||g>this.graph.tolerance))this.shape=this.createShape(),
...
mxConnectionHandler.prototype.getSourcePerimeterPoint=function(a,b,c){c=null;var d=a.view,e=d.getPerimeterFunction(a),f=new mxPoint(a.getCenterX(),a.getCenterY());if(null!=e){var g=mxUtils.getValue(a.style,mxConstants.STYLE_ROTATION,0),k=-g*(Math.PI/180);0!=g&&(b=mxUtils.getRotatedPoint(new mxPoint(b.x,b.y),Math.cos(k),Math.sin(k),f));a=e(d.getPerimeterBounds(a),a,b,!1);null!=a&&(0!=g&&(a=mxUtils.getRotatedPoint(new mxPoint(a.x,a.y),Math.cos(-k),Math.sin(-k),f)),c=a)}else c=f;return c};
...
(0!=b||0!=c)?(this.childOffsetX=this.state.x-this.bounds.x+e,this.childOffsetY=this.state.y-this.bounds.y+g):this.childOffsetY=this.childOffsetX=0;this.livePreview&&this.updateLivePreview(a);null!=this.preview&&this.drawPreview()};
...
mxEdgeHandler.prototype.createMarker=function(){var a=new mxCellMarker(this.graph),b=this;a.getCell=function(a){var d=mxCellMarker.prototype.getCell.apply(this,arguments);if((d==b.state.cell||null==d)&&null!=b.currentPoint)d=b.graph.getCellAt(b.currentPoint.x,b.currentPoint.y);if(null!=d&&!this.graph.isCellConnectable(d)){var e=this.graph.getModel().getParent(d);this.graph.getModel().isVertex(e)&&this.graph.isCellConnectable(e)&&(d=e)}e=b.graph.getModel();if(this.graph.isSwimlane(d)&&null!=b.currentPoint&&
this.graph.hitsSwimlaneContent(d,b.currentPoint.x,b.currentPoint.y)||!b.isConnectableCell(d)||d==b.state.cell||null!=d&&!b.graph.connectableEdges&&e.isEdge(d)||e.isAncestor(b.state.cell,d))d=null;this.graph.isCellConnectable(d)||(d=null);return d};a.isValidState=function(a){var d=b.graph.getModel(),d=b.graph.view.getTerminalPort(a,b.graph.view.getState(d.getTerminal(b.state.cell,!b.isSource)),!b.isSource),d=null!=d?d.cell:null;b.error=b.validateConnection(b.isSource?a.cell:d,b.isSource?d:a.cell);
...
this.bends[f].redraw();this.manageLabelHandle&&this.checkLabelHandle(this.bends[f].bounds);this.redrawInnerBends(a,c)}if(null!=this.abspoints&&null!=this.virtualBends&&0<this.virtualBends.length){a=this.abspoints[0];for(c=0;c<this.virtualBends.length;c++)null!=this.virtualBends[c]&&null!=this.abspoints[c+1]&&(d=this.abspoints[c+1],b=this.virtualBends[c],b.bounds=new mxRectangle(Math.floor(a.x+(d.x-a.x)/2-b.bounds.width/2),Math.floor(a.y+(d.y-a.y)/2-b.bounds.height/2),b.bounds.width,b.bounds.height),
...
mxDefaultPopupMenu.prototype.addItems=function(a,b,c,d,e,f,g){for(var k=!1;null!=f;){if("add"==f.nodeName){var l=f.getAttribute("if");if(null==l||e[l]){var l=f.getAttribute("as"),l=mxResources.get(l)||l,m=mxUtils.eval(mxUtils.getTextContent(f)),n=f.getAttribute("action"),p=f.getAttribute("icon"),q=f.getAttribute("iconCls"),s=f.getAttribute("enabled-if"),s=null==s||e[s];k&&(b.addSeparator(g),k=!1);null!=p&&this.imageBasePath&&(p=this.imageBasePath+p);l=this.addAction(b,a,l,p,m,n,c,g,q,s);this.addItems(a,
...
mxEditor.prototype.postDiagram=function(a,b){this.escapePostData&&(b=encodeURIComponent(b));mxUtils.post(a,this.postParameterName+"\x3d"+b,mxUtils.bind(this,function(c){this.fireEvent(new mxEventObject(mxEvent.POST,"request",c,"url",a,"data",b))}))};mxEditor.prototype.writeGraphModel=function(a){a=null!=a?a:this.linefeed;var b=(new mxCodec).encode(this.graph.getModel());return mxUtils.getXml(b,a)};mxEditor.prototype.getUrlPost=function(){return this.urlPost};mxEditor.prototype.getUrlImage=function(){return this.urlImage};
...
f,g=c.getAttribute("icon"),k=c.getAttribute("pressedIcon"),l=c.getAttribute("action"),m=c.getAttribute("mode"),n=c.getAttribute("template"),p="0"!=c.getAttribute("toggle"),q=mxUtils.getTextContent(c),s=null;if(null!=l)s=d.addItem(f,g,l,k);else if(null!=m)var r=mxDefaultToolbarCodec.allowEval?mxUtils.eval(q):null,s=d.addMode(f,g,m,k,r);else if(null!=n||null!=q&&0<q.length)s=e.templates[n],n=c.getAttribute("style"),null!=s&&null!=n&&(s=e.graph.cloneCells([s])[0],s.setStyle(n)),n=null,null!=q&&(0<q.length&&
mxDefaultToolbarCodec.allowEval)&&(n=mxUtils.eval(q)),s=d.addPrototype(f,g,s,k,n,p);else if(k=mxUtils.getChildNodes(c),0<k.length)if(null==g){n=d.addActionCombo(f);for(f=0;f<k.length;f++)p=k[f],"separator"==p.nodeName?d.addOption(n,"---"):"add"==p.nodeName&&(g=p.getAttribute("as"),p=p.getAttribute("action"),d.addActionOption(n,g,p))}else{var t=null,y=d.addPrototype(f,g,function(){var a=e.templates[t.value];if(null!=a){var a=a.clone(),b=t.options[t.selectedIndex].cellStyle;null!=b&&a.setStyle(b);return a}mxLog.warn("Template "+
a+" not found");return null},null,null,p),t=d.addCombo();mxEvent.addListener(t,"change",function(){d.toolbar.selectMode(y,function(a){a=mxUtils.convertPoint(e.graph.container,mxEvent.getClientX(a),mxEvent.getClientY(a));return e.addVertex(null,r(),a.x,a.y)});d.toolbar.noReset=!1});for(f=0;f<k.length;f++)p=k[f],"separator"==p.nodeName?d.addOption(t,"---"):"add"==p.nodeName&&(g=p.getAttribute("as"),q=p.getAttribute("template"),d.addOption(t,g,q||n).cellStyle=p.getAttribute("style"))}null!=s&&(n=c.getAttribute("id"),
