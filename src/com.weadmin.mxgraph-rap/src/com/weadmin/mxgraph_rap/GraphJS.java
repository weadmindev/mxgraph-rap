...
//		String xml = mxUtils.getXml(node);
	 ...
	 * 刷新节点信息
	 * @param array [JsonObject,JsonObject,...]
	 * JsonObject {"id":"id","tooltip":"tooltip","overlay":overlay}
	 * JsonObject overlay {"image":"html","width":width,"height":height,"tooltip":"tooltip"}
	 */
	public void updateNodeStatus(JsonArray array){
		JsonObject json = new JsonObject();
		json.set("array", array);
		super.callRemoteMethod("updateNodeStatus", json);
	}
